...
import com.example.gestionstock.Entities.Entreprise;
...
public class UtilisateurDto {
    ...
    public static UtilisateurDto fromEntity(Utlisiateur utilisateur) {
        if (utilisateur == null) {
            return null;
        }
    ...
    public static Utlisiateur toEntity(UtilisateurDto dto) {
        if (dto == null) {
            return null;
        }

        Utlisiateur utilisateur = new Utlisiateur();
